    ...
    <div className="app-container content-padding">
      ...
      <main>
        <div className="card text-center py-5">
          <h2 className="rewards-title mt-2 mb-2">
            Exciting Rewards Coming Soon!
          </h2>
          <p className="rewards-subtitle mb-5">
        ...
        <div className="card">
          <div className="p-4 border border-dashed border-gray-200 rounded-lg flex items-center mb-3">
