...
export const ShareDialog: React.FC<ShareDialogProps> = ({
  ...
  // 使用ReactDOM.createPortal确保对话框在DOM的根级别渲染
  return ReactDOM.createPortal(
    <>
      {isOpen && (
        <div
          className="modal-overlay fixed inset-0 z-[9999] bg-black bg-opacity-50"
          onClick={onClose}
        ></div>
      )}
      <div
      ...
      >
        <div
          className="modal-content bg-white rounded-3xl overflow-hidden shadow-lg"
    ...
    document.body // 确保直接渲染到body，防止被其他容器限制
  );
};
